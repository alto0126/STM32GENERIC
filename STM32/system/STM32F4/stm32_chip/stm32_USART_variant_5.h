...
const stm32_af_pin_list_type chip_af_usart_rts [] = { 
//USART1
    { USART1, GPIOA, GPIO_PIN_12  , GPIO_AF7_USART1}, 
//USART2
    { USART2, GPIOA, GPIO_PIN_1  ,  GPIO_AF7_USART2}, 
//USART3
    { USART3, GPIOB, GPIO_PIN_14 , GPIO_AF7_USART3}, 
};

const stm32_af_pin_list_type chip_af_usart_cts [] = { 
//USART1
    { USART1, GPIOA, GPIO_PIN_11  , GPIO_AF7_USART1}, 
//USART2
    { USART2, GPIOA, GPIO_PIN_0  ,  GPIO_AF7_USART2}, 
//USART3
    { USART3, GPIOB, GPIO_PIN_13 , GPIO_AF7_USART3}, 
};